...
/**
 * Created by rohit on 14/08/16.
 */

public class FetchWeatherService extends IntentService {
    public static final String LOCATION_QUERY_EXTRA = "lqe";
    private final String LOG_TAG = FetchWeatherService.class.getSimpleName();
    Messenger messenger;
    Message msg;
    ...
    protected void onHandleIntent(Intent intent) {
        Log.d(LOG_TAG,"Called in the service");
    ...
    private void getWeatherDataFromJson(String forecastJsonStr, int numDays)
        ...
        bundle.putStringArray("result",resultStrs);
        msg.setData(bundle); //put the data here
        try {
            messenger.send(msg);
        } catch (RemoteException e) {
            Log.i(LOG_TAG, "error in sending message back to fragment Activity");
        }
